        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto" style={{ justifyItems: 'center' }}>
            {[
              ...
              <div key={title} className="feature-card group bg-white rounded-2xl border border-slate-100 p-8 sm:p-9 w-full max-w-sm hover:shadow-xl hover:shadow-slate-200/50 hover:border-slate-200 transition-all duration-500 text-center">
