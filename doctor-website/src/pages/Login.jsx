...
function LoginForm({ email, setEmail, password, setPassword, showPassword, setShowPassword, error, loading, resetSent, resetLoading, handleSubmit, handleForgotPassword, mobile }) {
  return (
